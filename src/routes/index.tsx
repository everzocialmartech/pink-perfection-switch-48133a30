  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans antialiased">
      ...
      <section className="relative overflow-hidden min-h-[78vh] md:min-h-[82vh] flex items-center pt-12 md:pt-24 pb-8">
        ...
        <div
          className="absolute left-1/2 top-0 md:top-1/2 -translate-x-1/2 -translate-y-[18%] md:-translate-y-[42%] w-[360vw] h-[360vw] md:w-[88vw] md:h-[88vw] md:max-w-[820px] md:max-h-[820px] rounded-full animate-hero-glow-in"
          style={{
            background:
